 ...
 */
public class LanguageCursorAdapter extends AbstractCursorAdapter<LanguageCursorAdapter.ViewHolder> {

    private final LanguageActionListener mActionListener;

    private int mIndexId;
    private int mIndexName;


    public LanguageCursorAdapter(LanguageActionListener actionListener) {
        super(null, Contract.Language.ID);
    ...
    @Override
    public void onBindViewHolder(LanguageCursorAdapter.ViewHolder holder, Cursor cursor) {
        holder.mNameTextView.setText(cursor.getString(mIndexName));
    }

    @Override
    public LanguageCursorAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
